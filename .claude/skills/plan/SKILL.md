---
name: plan
description: This skill should be used when the user asks to create a plan, make a plan file, plan out a task, or uses "/plan". Creates a structured plan file with approaches considered, trade-offs, and a task checklist.
version: 1.0.0
---
